      ...
      {isRegistered === 'not' ? (
        ...
        <StyledFieldset>
          ...
          <div className="registerd1">
            <p>
              As part of the Code for America brigade network, Code for Chicago connects
              skills-based volunteers to Chicago-based nonprofits, mutual aid groups, and people
              with ideas on how they can improve their community.
            </p>
            <p className="registerp2">
              This contact form is for people who have completed our Onboarding Night and are
              interested in participating in Code for Chicago projects and committees. We created
              this formal process to cut down on the onboarding time. Our hope is to assign you to a
