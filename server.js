...
/*===== SLACK BOT =====*/
app.post(
  '/api/slack/send-welcome-message',
  verifyAuth,
  slackController.sendProjectWelcomeToVolunteer,
);
...
if (
  app.get('env') == 'development.local' &&
  process.env?.TEST_SLACK &&
  process.env?.TEST_SLACK_TOKEN
) {
  /**
