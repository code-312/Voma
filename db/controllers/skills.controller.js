...
exports.getSkills = async (req, res) => {
  var dbError;
  const skills = await models.skill.findAll().catch((err) => (dbError = err));
...
exports.addSkill = async (req, res) => {
  ...
  var dbError;
  const result = await models.skill
    .create({
      name,
      description,
    })
...
exports.editSkill = async (req, res) => {
  ...
  var dbError;
  skill.update({ name: name, description: description }).catch((err) => (dbError = err));
