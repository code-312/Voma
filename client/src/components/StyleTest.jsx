...
import { BoardSidebar } from '../styles/components/BoardContainer.style';
  ...
  return (
    <div>
      <div style={{ width: '600px', margin: 'auto' }}>
        ...
        <h3>I am H3</h3>
        <h4>I am h4</h4>I am just regular body copy.
        ...
        <h3>Colors:</h3>
        <div>
          <div style={{ backgroundColor: 'var(--managementBlue)', color: 'var(--white)' }}>
            ManagementBlue
          </div>
          ...
          <div style={{ backgroundColor: 'var(--blueShadeIII)', color: 'var(--white)' }}>
            blueShadeIII
          </div>
        ...
        <Button variant="solid blue">Test Button</Button>
        <Button variant="solid white" icon={AlertCircle} iconSize="18">
          Test Button
        </Button>
        <Button variant="solid red">Test Button</Button>
        <Button variant="outline blue">Test Button</Button>
        <Button variant="fw outline blue">Test Button</Button>
        <Button variant="fw outline white">Test Button</Button>
        <Button variant="text-only red">Test Button</Button>
        ...
        <div style={{ marginTop: '15px' }}>
          <ContentBox
            ...
            bodyContent={[
              <h2 key="thing1">Content 1</h2>,
              <h2 key="thing2">Content 2</h2>,
              <h2 key="thing3">Content 3</h2>,
            ]}
