...
const BackgroundForm = ({ volunteer, updateInfo, updateVolunteerArray, setCanProceed }) => {
  useEffect(() => {
    setCanProceed(
      allValid([volunteer.goal]) &&
        allArraysPopulated([
  ...
  return (
    <div>
      ...
      <ProfileInfoContainer>
        <Label3>
          Are you hoping to further develop a core skill set or looking to try something new?
        </Label3>
        <StackedInput
