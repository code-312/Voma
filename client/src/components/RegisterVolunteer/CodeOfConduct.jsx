  ...
  return (
    <div>
      ...
      <CocContainer>
        ...
        <BodyText2>Are a place where people are free to fully express their identities.</BodyText2>
        <BodyText2>
        ...
        <BodyText2>Encourage members and participants to listen as much as they speak.</BodyText2>
        <BodyText2>
