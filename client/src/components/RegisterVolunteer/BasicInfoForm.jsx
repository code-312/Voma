...
export default function BasicInfoForm({
  ...
  useEffect(() => {
    setCanProceed(allValid([name, email, pronouns, jobTitle, employer, student]));
  }, [name, email, pronouns, jobTitle, employer, student, setCanProceed]);
  ...
  return (
    <div>
      ...
      <ProfileInfoContainer>
        <Label3>
          Are you currently in a formal education program or have recently graduated within the last
          12 months?
        </Label3>
        <StackedInput
